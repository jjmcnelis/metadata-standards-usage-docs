...
EDI supports the [Long-Term Ecological Research (LTER) Network](https://lternet.edu/) and is a [DataONE](https://dataone.org) member node.

Data are exposed through the EDI Data Portal ([Metacat UI](https://github.com/NCEAS/metacatui)): https://portal.edirepository.org/nis/home.jsp

EDI publishes metadata compliant with the [Ecological Metadata Language (EML)](https://eml.ecoinformatics.org/) specification.

EDI’s ([PASTA+](https://pastaplus-core.readthedocs.io/en/latest/doc_tree/about.html)) data repository software environment  accepts data in any digital format. All science data curated by EDI in the PASTA+ environment, either submitted by an external user or generated internally as a derived product, is required to be described and documented with the Ecological Metadata Language (EML) standard (see: https://knb.ecoinformatics.org/tools/ eml). The PASTA+ data repository software supports versions 2.1.0, 2.1.1, and 2.2.0 of EML. EML is a semantically rich science metadata standard that is specified in the form of an XML schema. The EML standard is actively supported as an open source project.

![EDI infrastructure](https://environmentaldatainitiative.files.wordpress.com/2017/05/edi-infrastructure.png?w=1024)
*source: https://environmentaldatainitiative.org/*

**notes:**

I found this GitHub repository under the EDI account: https://github.com/EDIorg/MetadataTemplates (*They couldn't possibly receive all their metadata in word documents, right?*)
